            ...
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0" style="background-color:#1a7a45">
                    ...
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu m-0">
                                <a href="{{ url('infografis/penduduk') }}" class="dropdown-item {{ Request::is('infografis/penduduk') ? 'active text-white fw-bold' : 'text-white' }}">Penduduk</a>
                ...
                <nav class="mobile-bottom-nav d-none">
                    <div class="mobile-bottom-nav-wrapper">
                        ...
                        <a href="{{ url('infografis/penduduk') }}" class="nav-item {{ Request::is('infografis/penduduk') ? 'active' : '' }}"><i class="fas fa-chart-bar"></i><span>Penduduk</span></a>
